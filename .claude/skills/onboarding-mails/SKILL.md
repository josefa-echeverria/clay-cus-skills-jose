...
compatibility: "Requiere HubSpot MCP, Gmail MCP, Diio MCP (solo Mail 1), y Metabase Clay (execute_card sobre el dashboard 607, cards 6206 y 6207, más execute_query para las cards 6301 y 6230 en grupos madre/hijas) para todo dato de avance/checklist/conciliación. No usa Clay MCP ni consultas SQL directas a sources.* — ver references/decisiones_pendientes.md para el historial de por qué."
---
